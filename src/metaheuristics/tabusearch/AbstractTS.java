...
public abstract class AbstractTS<E> {
	public enum LocalSearchMethod {FIRST_IMPROVING, BEST_IMPROVING};
	...
	protected LocalSearchMethod localSearchMethod;
	...
	public abstract Solution<E> neighborhoodMoveFirst();
	...
	public Solution<E> solve() {
		...
		for (int i = 0; i < iterations; i++) {
			if (localSearchMethod.FIRST_IMPROVING == localSearchMethod){
				neighborhoodMoveFirst();
